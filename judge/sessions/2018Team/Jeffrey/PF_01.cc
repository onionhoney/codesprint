...
inline int play3(tileset& tiles) {
    return tiles.begin()->v;
}
...
void main2() {
    ...
    tileset rel;
    for (int i = 0; i < min(10LL, sz(tiles)); i++) {
        rel.insert(tiles[i]);
    }
